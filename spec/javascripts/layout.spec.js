describe("layout", function(){
  ...
  describe("when a template has inlined region definitions", function(){
    var layout, view1, view2;

    beforeEach(function(){
      loadFixtures("inlineRegionDefinition.html");

      layout = new Backbone.Marionette.Layout({
        template : '#inlineRegionDefinition'
      });
      layout.render();
      view1 = new Backbone.Marionette.View();
      view2 = new Backbone.Marionette.View();
    });
